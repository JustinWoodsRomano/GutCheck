...
const INSPECTION_REASONS = [
  ...
  // Closes the last gap: 6 records carry "Non-Inspection", which matched
  // nothing above and left those cards with no tag at all.
  { re: /non-?inspection/i, label: "Non-inspection", tone: "neutral" },
];
