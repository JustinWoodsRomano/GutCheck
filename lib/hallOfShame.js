...
export const HALL_OF_SHAME = [
  ...
  },
  {
    ...
    match: "MORE LIVE ROACHES CRAWLING IN BETWEEN CRACKS AND CREVICES IN",
    revealed: false,
  ...
  },
  {
    ...
    match: "2 LIVE ROACHES IN FACILITY, INCLUDING IN DINING ROOM AND",
    revealed: false,
    caption: "A Lakeview mainstay that closed permanently weeks after this inspection.",
  },
  {
  ...
  },
  {
    ...
    match: "4- LIVE ROACHES CRAWLING ON WALL & DISH RACK IN DISH MACHINE",
    revealed: false,
  ...
  },
  {
    ...
    match: "RODENT INFESTATION OBSERVED ON PREMISES. FOUND 400 MOUSE",
    revealed: false,
    caption: null,
  },
  {
